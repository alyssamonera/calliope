...
Reply.create({
  "title" => "At Last!",
  "body" => "Quisque egestas nibh posuere felis semper, quis tempus massa consequat. Nunc imperdiet at arcu a maximus. Praesent vel egestas ligula, ut cursus dui. Aliquam erat volutpat. Mauris vel nisl non lorem dictum cursus. Curabitur porta in elit non pretium. Curabitur sit amet sem sit amet orci dictum placerat. Integer suscipit sodales tortor quis ultrices. Fusce luctus nisl ac augue sodales egestas.",
  "user_id" => 1,
  "prompt_id" => 2
  })
